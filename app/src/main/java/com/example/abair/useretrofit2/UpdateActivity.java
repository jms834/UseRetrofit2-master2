...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText cTel = (EditText) findViewById(R.id.textViewDataPhone);
        cTel.setText(repo.cTel);
    ...
    public void update(View view)
    {
        ...
        myApp.StudentInformation.cTel = ((EditText)findViewById(R.id.textViewDataPhone)).getText().toString();
