...
//                .baseUrl("https://api.github.com/")
                .baseUrl("http://192.168.58.20:8081/code/11-14_project/")
...
//                });
        ...
        if( requestCode == 1 && resultCode == Activity.RESULT_OK)
        {
            ...
            repo.cTel = (String) data.getExtras().getSerializable("cTel");
...
//            String tmp = "'cName'='mike', 'cAddr'='', 'cBirthday'='', 'cEmail'='', 'cTel'='', 'cSex'=''";
//
